...
parser.add_argument("-v", help = "default: false, if true: includes more data to display", type = bool,default = false)
parser.add_argument("-h", help = "additional header line for the request, host is autogenerated", type = str,default = None)
...
run_httpclient(args.httpc, args.port, args.URL, args.v, args.h, args.d, args.f)
